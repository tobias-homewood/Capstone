...
class BoardForm(FlaskForm):
    ...
    board_location = StringField('Board Location', validators=[InputRequired()])
    ...
    width_fraction = SelectField('Width Fraction', choices=[('1/8', '1/8'), ('1/4', '1/4'), ('3/8', '3/8'), ('1/2', '1/2'), ('5/8', '5/8'), ('3/4', '3/4'), ('7/8', '7/8')], validators=[InputRequired()])    
    depth_integer = SelectField('Depth Integer', choices=[(str(i), str(i)) for i in [2, 3, 4]], validators=[InputRequired()])
    depth_fraction = SelectField('Depth Fraction', choices=[('1/8', '1/8'), ('1/4', '1/4'), ('3/8', '3/8'), ('1/2', '1/2'), ('5/8', '5/8'), ('3/4', '3/4'), ('7/8', '7/8')], validators=[InputRequired()])    
...
class SearchForm(FlaskForm):
    ...
    board_location = StringField('Board Location', validators=[Optional()])
    ...
    width_fraction = SelectField('Width Fraction', choices=[('', 'Any'), ('1/8', '1/8'), ('1/4', '1/4'), ('3/8', '3/8'), ('1/2', '1/2'), ('5/8', '5/8'), ('3/4', '3/4'), ('7/8', '7/8')], validators=[Optional()])    
    ...
    depth_fraction = SelectField('Depth Fraction', choices=[('', 'Any'), ('1/8', '1/8'), ('1/4', '1/4'), ('3/8', '3/8'), ('1/2', '1/2'), ('5/8', '5/8'), ('3/4', '3/4'), ('7/8', '7/8')], validators=[Optional()])    
